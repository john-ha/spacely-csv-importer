...
ActiveRecord::Schema[7.2].define(version: 2024_09_27_143916) do
  ...
  create_table "import_histories_properties", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["import_history_id", "property_id"], name: "idx_on_import_history_id_property_id_b9c60664be", unique: true
    t.index ["import_history_id"], name: "index_import_histories_properties_on_import_history_id"
    t.index ["property_id"], name: "index_import_histories_properties_on_property_id"
  end
