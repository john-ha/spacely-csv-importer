...
RSpec.describe Imports::ParseCsvService, type: :service do
  describe "#call" do
    ...
    context "when the file contains only valid data" do
      ...
      let(:imported_file) { fixture_file_upload("valid_data.csv") }
    ...
    context "when the file contains invalid data" do
      let(:import_status) { :in_progress }
      let(:imported_file) { fixture_file_upload("invalid_rows_data.csv") }
    ...
    context "when the file contains invalid headers" do
      let(:import_status) { :in_progress }
      let(:imported_file) { fixture_file_upload("invalid_headers_data.csv") }
